  ...
  return (
    <section>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="p-10 rounded-2xl bg-success/10 backdrop-blur-md border border-success/30 group hover:bg-success/20 transition-all duration-300">
        ...
        <div className="p-10 rounded-2xl bg-primary/10 backdrop-blur-md border border-primary/30 group hover:bg-primary/20 transition-all duration-300">
          <div className="flex items-center gap-4 mb-6">
