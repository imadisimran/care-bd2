  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        {/* Left: Contact Form */}
        <div className="lg:col-span-7 bg-surface-container-lowest p-8 md:p-12 rounded-xl shadow-[0_10px_40px_rgba(27,28,25,0.04)]">
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input 
                  className="w-full bg-surface-container-low border-none rounded-sm px-4 py-3 focus:ring-2 focus:ring-primary focus:bg-surface-container-lowest transition-all duration-300 outline-none" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full bg-surface-container-low border-none rounded-sm px-4 py-3 focus:ring-2 focus:ring-primary focus:bg-surface-container-lowest transition-all duration-300 appearance-none outline-none">
            ...
            <button className="w-full bg-tertiary-container text-on-tertiary-container py-4 rounded-full font-bold text-lg hover:scale-[1.02] transition-transform duration-300 active:scale-95 shadow-sm" type="button">
              Send Message
            </button>
          </form>
        </div>
          ...
          <div className="bg-primary p-8 rounded-lg text-white whisper-shadow relative overflow-hidden group">
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-4">
                <span className="material-symbols-outlined text-4xl text-secondary-fixed-dim">emergency</span>
                <h3 className="text-2xl font-bold">24/7 Emergency Hotline</h3>
              </div>
              <p className="text-primary-fixed text-lg mb-4">Direct line for critical healthcare situations and immediate caregiver dispatch.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6">
            ...
            <div className="bg-surface-container-high p-6 rounded-lg flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-on-surface-variant text-sm">742 Healing Springs Blvd, Suite 400<br/>Portland, OR 97201</p>
              </div>
            </div>
          </div>

          <div className="bg-tertiary-fixed p-6 rounded-lg flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-bold text-on-tertiary-fixed-variant">Certified &amp; Trusted</h4>
                <div className="flex items-center gap-1">
                  <span className="material-symbols-outlined text-sm text-tertiary" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                  <span className="material-symbols-outlined text-sm text-tertiary" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                  <span className="material-symbols-outlined text-sm text-tertiary" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                  <span className="material-symbols-outlined text-sm text-tertiary" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                  <span className="material-symbols-outlined text-sm text-tertiary" style={{ fontVariationSettings: "'FILL' 1" }}>star_half</span>
                  <span className="text-xs font-bold text-on-tertiary-fixed-variant ml-2">4.9/5 Rating</span>
                </div>
              </div>
            </div>
          </div>
